            ...
            component: {
                ...
                passProps: {
                    tempData: Object.assign(this.props.tempData, {
                        avatarPhoto: this.state.selectedPhoto
                    })
                }
            }
        })
            ...
            <View style={{ flex: 1 }}>
                <View style={{ alignItems: "center" }}>
                    <View style={{ marginTop: 10 }}>
                        <Text style={styles.textHeader}>Upload an avatar photo to add to your profile</Text>
                    </View>
                    <View>
                        <Thumbnail
    ...
    afterSelect() {
        return (
            <View style={{ flex: 1 }}>
                ...
                <View style={{ flex: 1, marginTop: 20, alignItems: "center" }}>
                    <Image
                        style={{ width: 300, height: 300, borderWidth: 1, borderColor: "#bbb" }}
